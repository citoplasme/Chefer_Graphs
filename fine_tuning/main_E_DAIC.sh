...
#SBATCH --mem=72GB
#SBATCH --job-name=Fine-tuning-E_DAIC
#SBATCH --output=Fine-tuning-E_DAIC_%j.out
...
python main.py --data_set E-DAIC --use_label_smoothing 0 --use_gradient_clipping 1 --checkpoint_validation_loss 1