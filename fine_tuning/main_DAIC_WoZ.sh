...
#SBATCH --mem=72GB
#SBATCH --job-name=Fine-tuning-DAIC-WoZ
#SBATCH --output=Fine-tuning-DAIC-WoZ_%j.out
...
python main.py --data_set DAIC-WoZ --use_label_smoothing 0 --use_gradient_clipping 1 --checkpoint_validation_loss 1