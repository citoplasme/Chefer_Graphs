...
#SBATCH --mem=72GB
#SBATCH --job-name=Attention-distillation-SST-2
#SBATCH --output=Attention-distillation-SST-2_%j.out
...
python main.py --data_set SST-2 --use_label_smoothing 0 --use_gradient_clipping 0 --checkpoint_validation_loss 1 --use_accuracy 1 --use_balanced_loss 0 --fine_tuning_trial_number 104 --subsample_percentage 1.0