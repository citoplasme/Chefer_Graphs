...
def unbound_objective_function(trial):
  ...
  #
  threshold : float = HYPER_PARAMETERS['threshold']['value'] if HYPER_PARAMETERS['threshold']['fixed'] else (trial.suggest_float('threshold', *UNBOUND_LIMITS['threshold'], log = HYPER_PARAMETERS['threshold']['log']))
  #
