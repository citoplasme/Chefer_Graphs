...
#SBATCH --mem=72GB
#SBATCH --job-name=Attention-distillation-DBPedia
#SBATCH --output=Attention-distillation-DBPedia_%j.out
...
python main.py --data_set DBPedia --use_label_smoothing 1 --use_gradient_clipping 1 --checkpoint_validation_loss 1 --use_accuracy 1 --use_balanced_loss 0 --fine_tuning_trial_number 0 --subsample_percentage 0.03