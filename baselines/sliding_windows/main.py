...
def train_and_predict(
  ...
  try:
    ...
    os.makedirs(os.path.join(SCRATCH_PATH, f'{DATASET}-Sliding_windows', f'{window_size}', 'validation'), exist_ok = True)
    data_sets.pre_construct_all_graphs_for_split(
      validation_df,
      #
    ...
    if not evaluate_test:
      ...
      os.makedirs(os.path.join(SCRATCH_PATH, f'{DATASET}-Sliding_windows', f'{window_size}', 'test'), exist_ok = True)
      data_sets.pre_construct_all_graphs_for_split(
        testing_df,
        #
