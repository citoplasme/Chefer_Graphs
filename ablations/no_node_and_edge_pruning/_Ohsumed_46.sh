...
cd ..
python main_single_seed.py --data_set Ohsumed --use_label_smoothing 0 --use_gradient_clipping 0 --checkpoint_validation_loss 1 --use_accuracy 0 --use_balanced_loss 1 --fine_tuning_trial_number 0 --ablation 6 --seed 46