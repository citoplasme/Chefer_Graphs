...
cd ..
python main.py --data_set R8 --use_label_smoothing 1 --use_gradient_clipping 1 --checkpoint_validation_loss 1 --use_accuracy 0 --use_balanced_loss 1 --fine_tuning_trial_number 0 --ablation 2